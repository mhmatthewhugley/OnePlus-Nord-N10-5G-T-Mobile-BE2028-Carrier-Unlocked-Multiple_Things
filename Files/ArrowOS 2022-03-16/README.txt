...
23. Click "Enter recovery"
24. Click "Advanced" Then click "Reboot to recovery"
25. Go to "Apply update" and choose "Apply from ADB"
26. Sideload the ROM by running "adb sideload <rom.zip>"
27. When it is done get to the main screen by using the volume key to go to the arrow and clicking the power button on the arrow to go back a page.
28. Click "Advanced" then "Enter fastboot"
29. Flash recovery again. "fastboot flash recovery <recovery.img>"
30. Flash the patched boot image with "fastboot flash boot <magisk_patched-numbers_lettersnumber.img>"
